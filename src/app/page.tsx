...
export default function Home() {
  return (
    <main className="min-h-screen bg-deep-black">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-neon-blue/5 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-black mb-8 text-white">Ready to secure your AI future?</h2>
