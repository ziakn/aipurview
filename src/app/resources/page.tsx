        ...
        <main className="bg-deep-black min-h-screen text-white">
            ...
            <section className="pt-40 pb-20 relative border-b border-white/5">
                <div className="container mx-auto px-6">
                    <h1 className="text-5xl font-black mb-8">Knowledge Hub</h1>
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                        <div className="relative w-full md:w-2/3">
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-16 pr-8 focus:outline-none focus:border-neon-blue/50 transition-all text-white placeholder:text-white/20"
                            />
                        </div>
            ...
            <Section className="!pt-12">
                <div className="flex items-center space-x-2 mb-8">
                    ...
                    <h2 className="text-xl font-bold uppercase tracking-widest text-white/80">Upcoming Publication</h2>
                </div>
                <div className="glass-card p-12 bg-gradient-to-br from-neon-blue/20 via-transparent to-transparent flex flex-col md:row items-center gap-12 border-neon-blue/20 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-8">
                        <div className="px-4 py-1.5 bg-neon-blue text-deep-black text-[10px] font-black uppercase tracking-widest rounded-full">
                            Featured Book
                        </div>
                    </div>
                    <div className="md:w-1/3">
                        <div className="aspect-[3/4] bg-white/5 border border-white/10 rounded-xl shadow-2xl relative overflow-hidden group-hover:rotate-2 transition-transform duration-500">
                            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-deep-black to-transparent">
                                ...
                                <h3 className="text-xl font-bold leading-tight">Mastering AI Governance</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredResources.map((res, index) => (
                        <motion.div
                            ...
                            className="glass-card p-8 flex flex-col justify-between hover:bg-white/[0.03] transition-colors cursor-pointer group"
                        >
                            <div>
                                <div className="flex justify-between items-start mb-6">
                                    <div className="p-3 bg-white/5 rounded-xl text-white/30 group-hover:text-neon-blue transition-colors">
                                        {res.category === "Toolkits" ? <Download className="w-6 h-6" /> : < Newspaper className="w-6 h-6" />}
                                    </div>
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-white/30 px-2 py-1 bg-white/5 rounded">
                                        {res.category}
                                    </span>
                                </div>
                            ...
                            <div className="pt-8 flex items-center justify-between border-t border-white/5 mt-8">
                                <span className="text-xs font-bold text-white/30 uppercase tracking-widest">Read More</span>
                                <ArrowUpRight className="w-4 h-4 text-white/30 group-hover:text-neon-blue group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" />
                            </div>
                        </motion.div>
                    ))}
                </div>
